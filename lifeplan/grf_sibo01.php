...
window.onload = function() {
	ctx = document.getElementById('canvas_si_01').getContext('2d');
...
<script>
var barChartData = {
	labels: [<?php  echo $_GET['cnt']; ?>],
	datasets: [
		{
			type: 'bar',
			label: '各年で不足する生活費',
			data: [<?php echo $_GET['sibo']; ?>],
...
<div style="position:absolute;right:8px;margin:-1% 0 0 0;font-size:11px;">年後</div>
</body>
</html>
