...
<?php
$word = 'Ç‹Ç∏ÇÕ<a href=" https://www.fp-support-engineer.com/topic_rule/"><b>Ç±ÇøÇÁ</b></a>ÇÇ®ì«Ç›â∫Ç≥Ç¢ÅB';
$sjis =  mb_convert_encoding($word, "UTF-8", "SJIS");
echo '<div class="topic_info">'.$sjis.'</div>';
?>
